...
public struct HakoLogTextView: View {
    ...
    private var platformView: some View {
        #if os(iOS)
            HakoLogTextViewIOS(entries: entries, followsEnd: followsEnd, colorScheme: colorScheme)
        #elseif os(macOS)
            HakoLogTextViewMacOS(entries: entries, followsEnd: followsEnd, colorScheme: colorScheme)
        #else
            EmptyView()
        #endif
    }
